...
func (x *UserListRequest) GetFilter() *UserInfo {
	if x != nil {
		return x.Filter
	}
	return nil
...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x41, 0x0a, 0x0f,
	...
	0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22,
	0x46, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08, 0x75,
	0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x5a, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x49,
...
var file_proto_user_proto_goTypes = []interface{}{
	...
	(*UserInfo)(nil),           // 6: user_service.UserInfo
}
var file_proto_user_proto_depIdxs = []int32{
	6, // 0: user_service.UserListRequest.filter:type_name -> user_service.UserInfo
	6, // 1: user_service.UserListResponse.userList:type_name -> user_service.UserInfo
	0, // 2: user_service.User.AddUser:input_type -> user_service.AddUserRequest
	2, // 3: user_service.User.RemoveUser:input_type -> user_service.RemoveUserRequest
	4, // 4: user_service.User.UserList:input_type -> user_service.UserListRequest
	1, // 5: user_service.User.AddUser:output_type -> user_service.AddUserResponse
	3, // 6: user_service.User.RemoveUser:output_type -> user_service.RemoveUserResponse
	5, // 7: user_service.User.UserList:output_type -> user_service.UserListResponse
